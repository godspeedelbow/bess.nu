import photo1 from "../photos/1019-24-juli-2018-de-oostkant-van-ons-is-heuvelachtig-800px.jpg";
import photo2 from "../photos/1019-24-juli-2018-de-oceaan-maakt-de-grillige-westkust-van-ons-800px.jpg";
import photo3 from "../photos/1019-24-juli-2018-de-ondergrondse-grot-bij-buraco-do-inferno-800px.jpg";

export default {
  id: "1019",
  title: "Ons",
  created: "24 juli 2018",
  location: "Portonovo",
  geolocation: {
    lat: 42.40305556,
    lng: -8.82472222
  ...
  paragraphs: [
    `Ons en Cies zijn twee eilandjes. Ze liggen voor de ingang van de Ria Pontevedra (Ons) en de Ria de Vigo (Cies). Ze beschermen deze twee zuidelijke ria's tegen het geweld van de oceaan. Niet voor niets dat de Spaanse overheid de eilanden tot nationaal park verheven heeft. Dat betekent dat je een 'permit' moet hebben om er te mogen varen, ankeren en duiken. We hebben een permit aangevraagd voor Ons en voor Cies.`,
  ...
  photos: [
    {
      src: photo1,
      title: "De oostkant van Ons is heuvelachtig."
    },
    {
      src: photo2,
      title: "De oceaan maakt de grillige westkust van Ons."
    },
    {
      src: photo3,
