...
function Crew() {
  return (
    <Fragment>
      ...
      <Paragraph>
        Zo mooi als Porgy dat kon zingen (Gershwin 1935), kunnen wij het niet.
        Maar we zijn wel enorm trots op onze stoere Sentijn1133. In alle
        opzichten een echte Koopmans (van Dick jr) uit 1995. Inmiddels hebben we
        er al een dikke 25.000 mijl mee gevaren.
      </Paragraph>
